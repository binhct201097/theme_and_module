...
! function(t) {
    ...
    i.parseTarget = function(t) {
        ...
        return {
            ...
            _trigger: function(i, e, n) { var r, l = !1; return n = [this].concat(n || []), (e || this._element).each(function() { r = t.Event((s + ":" + i).toLowerCase()), t(this).trigger(r, n), r.isDefaultPrevented() && (l = !0) }), !l }
        }
    }, i.plugin = function(s, e) {
        var n = t[s] = function(i, s) { this._element = t(i), this.options(s), this._init(), this.create() };
        return n.fn = n.prototype = t.extend({}, i.base(s), e), t.fn[s] = function(i) {
            var e = Array.prototype.slice.call(arguments, 1),
                r = this;
            return "string" == typeof i ? this.each(function() { var n = t(this).data(s); if (!n) return t.error("Cannot call methods on " + s + ' prior to initialization; attempted to call method "' + i + '"'); if (!t.isFunction(n[i]) || "_" === i.charAt(0)) return t.error('No such method "' + i + '" for ' + s + " instance"); var l = n[i].apply(n, e); return l !== n && void 0 !== l ? (r = l, !1) : void 0 }) : this.each(function() {
                var e = t(this).data(s);
...
function(t, i) {
    ...
    t.jCarousel.plugin("jcarousel", {
        ...
        _create: function() { this._reload(), s.on("resize.jcarousel", this.onWindowResize) },
        _destroy: function() { s.off("resize.jcarousel", this.onWindowResize) },
        _reload: function() {
            this.vertical = this.options("vertical"), null == this.vertical && (this.vertical = e(this.list().height()) > e(this.list().width())), this.rtl = this.options("rtl"), null == this.rtl && (this.rtl = function(i) { if ("rtl" === ("" + i.attr("dir")).toLowerCase()) return !0; var s = !1; return i.parents("[dir]").each(function() { if (/rtl/i.test(t(this).attr("dir"))) return s = !0, !1 }), s }(this._element)), this.lt = this.vertical ? "top" : "left", this.relative = "relative" === this.list().css("position"), this._list = null, this._items = null;
        ...
        hasPrev: function() { if (!1 === this._trigger("hasprev")) return !0; var t = this.options("wrap"); return !!(this.items().length > 0 && !this.underflow && (t && "last" !== t || this.index(this._first) > 0 || this.tail && this.inTail)) },
        clipping: function() { return e(this._element["inner" + (this.vertical ? "Height" : "Width")]()) },
        dimension: function(t) { return e(t["outer" + (this.vertical ? "Height" : "Width")](!0)) },
        ...
        move: function(i, s) {
            ...
            if (!n && h > 0) o.animate(i, s);
                ...
                var a = s.complete || t.noop,
                    u = {};
                if (n) {
                    var c = { transitionDuration: o.css("transitionDuration"), transitionTimingFunction: o.css("transitionTimingFunction"), transitionProperty: o.css("transitionProperty") },
                        f = a;
                    a = function() { t(this).css(c), f.call(this) }, u = { transitionDuration: (h > 0 ? h / 1e3 : 0) + "s", transitionTimingFunction: e.easing || s.easing, transitionProperty: h > 0 ? r || l ? "all" : i.left ? "left" : "top" : "none", transform: "none" }
                }
                l ? u.transform = "translate3d(" + (i.left || 0) + "," + (i.top || 0) + ",0)" : r ? u.transform = "translate(" + (i.left || 0) + "," + (i.top || 0) + ")" : t.extend(u, i), n && h > 0 && o.one("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd", a), o.css(u), h <= 0 && o.each(function() { a.call(this) })
            }
        },
        ...
        _scrollTail: function(i, s) {
            ...
            var r = {};
            return r[this.lt] = n + "px", this._update({ target: this._target.next(), fullyvisible: this._fullyvisible.slice(1).add(this._visible.last()) }), this._animate(r, i, s), this
        },
        _animate: function(i, s, e) {
            ...
            var n = this.options("animation"),
                ...
                h = l.complete || t.noop;
            return !1 === s ? l.duration = 0 : void 0 !== t.fx.speeds[l.duration] && (l.duration = t.fx.speeds[l.duration]), l.complete = function() { r(), h.call(this) }, this.move(i, l), this
        },
        _prepare: function(i) {
            var s, n, r, l = this.index(i),
                ...
                f = { target: i, first: i, last: i, visible: i, fullyvisible: o <= a ? i : t() };
            if (c && (o /= 2, a /= 2), o < a)
                for (;;) {
        ...
        _update: function(i) {
            var s, e = this,
                ...
                l = function(s) {
                    var l = [],
                        h = [];
                    i[s].each(function() { n[s].index(this) < 0 && l.push(this) }), n[s].each(function() { i[s].index(this) < 0 && h.push(this) }), r ? l = l.reverse() : h = h.reverse(), e._trigger(s + "in", t(l)), e._trigger(s + "out", t(h)), e["_" + s] = i[s]
                };
            for (s in i) l(s);
            return this
        }
